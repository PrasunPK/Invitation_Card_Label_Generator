...
public class GuestsTest {
    ...
    public void setUp() throws Exception {
        ...
        g3 = new Guest(new Name("Velma", "Bergstrom"), Gender.FEMALE, new Age(24), new Address(new City("Katlynn view"), new State("Vermont"), new Country("Macedonia")));
        ...
        g5 = new Guest(new Name("Velma", "Bergstrom"), Gender.FEMALE, new Age(24), new Address(new City("West Shanna"), new State("South Carolina"), new Country("Bangladesh")));
        list.add(g1);
        list.add(g2);
        list.add(g3);
        list.add(g4);
    ...
    public void test_getFrom_provides_all_the_guests_from_a_particular_country_given_to_it() throws Exception {
        ...
        assertArrayEquals(expectedGuestList, list.representGuests());
    }
